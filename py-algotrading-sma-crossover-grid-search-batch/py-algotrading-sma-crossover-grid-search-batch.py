...
# # Algorithmic Trading Model for Simple Moving Average Crossover Grid Search Batch Mode
# ### David Lowe
# ### June 17, 2020
# 
...
filename = "algotrading-sma-crossover_" + datetime.now().strftime('%Y%m%d') + "_" + sys.argv[1] + ".txt"
f = open(filename, 'w')
sys.stdout = f
